...
> Universal AI Bus with automatic failover, performance ranking, rate limiting, and **126+ free LLM models** from 11 providers.
...
- **138+ Models** — Including 49+ completely free models
...
**Models:** Llama 3.3 70B, Llama 3.1 8B, Llama 4 Maverick/Scout, Qwen 3 32B, Kimi K2, GPT-OSS 120B/20B, Allam 2.7B, Groq Compound Mini, Groq Compound, Moonshot AI Kimi K2 Instruct 0905, Meta Llama Prompt Guard 2 86M, Llama Guard 4 22M, Qwen 3.6 27B, Qwen 3.8 27B
